...
//let independentreserve = resolve.independentreserve();
...
exchangeValues.then(response => console.log("Values: " + response)); //works
 ...
 anxpro.then(response => console.log("Anxpro: " + JSON.stringify(response[0])));
 ...
 bitbay.then(response => console.log("Bitbay: " + JSON.stringify(response[0])));
 ...
 bithumb.then(response => console.log("Bithumb: " + JSON.stringify(response[0])));
 ...
 bitz.then(response => console.log("BitZ: " + JSON.stringify(response[0])));
 btcmarkets.then(response => console.log("BtcMarkets: " + JSON.stringify(response[0])));
 ...
 bxinth.then(response => console.log("Btctradeim: " + JSON.stringify(response[0])));
 cex.then(response => console.log("CEX: " + JSON.stringify(response[0])));
 coinbasepro.then(response => console.log("Coinbasepro: " + JSON.stringify(response[0])));
 coinegg.then(response => console.log("Coinegg: " + JSON.stringify(response[0])));
 coinex.then(response => console.log("Coinex: " + JSON.stringify(response[0])));
 coinexchange.then(response => console.log("Coinexchange: " + JSON.stringify(response[0])));
 ...
 coingi.then(response => console.log("Coingi: " + JSON.stringify(response[0])));
 coinmate.then(response => console.log("Coinmate: " + JSON.stringify(response[0])));
 ...
 cryptopia.then(response => console.log("Cryptopia: " + JSON.stringify(response[0])));
 ...
 gateio.then(response => console.log("Gateio: " + JSON.stringify(response[0])));
 ...
 hitbtc2.then(response => console.log("HitBtc: " + JSON.stringify(response[0])));
 ice3x.then(response => console.log("Ice3x: " + JSON.stringify(response[0])));
 itbit.then(response => console.log("Iitbit: " + JSON.stringify(response[0])));
 kraken.then(response => console.log("Kraken: " + JSON.stringify(response[0])));
 ...
 lakebtc.then(response => console.log("LakeBTC: " + JSON.stringify(response[0])));
 liqui.then(response => console.log("Liqui: " + JSON.stringify(response[0])));
